...
223 PRINT TAB(YY);"   '-------- --'      / /"
224 PRINT TAB(YY);"       ,---' '-------/ /--,"
225 PRINT TAB(YY);"        '----------------'":PRINT:PRINT:
    FOR ZZ=1 TO 7:PRINT CHR$(11);:NEXT ZZ:NEXT YY
...
1260 PRINT"   ON STARDATE";T0+T9;CHR$(8);
     ". THIS GIVES YOU";T9;"DAYS. THERE";X0$
...
1300 INPUT I5$:IF LEFT$(I5$,1)="N" OR LEFT$(I5$,1)="n" THEN RUN "TREKINST" ELSE
     IF LEFT$(I5$,1)="Y" OR LEFT$(I5$,1)="y" THEN 1310 ELSE 1280
1310 PRINT CHR$(26)
...
5110 PRINT:PRINT CHR$(22);"*** KLINGON DESTROYED ***";CHR$(22):PRINT:
     K3=K3-1:K9=K9-1:IF K9<=0 THEN 6370
...
6080 PRINT:PRINT H;"UNIT HIT ON ENTERPRISE FROM SECTOR";K(I,1);CHR$(8);
     ",";K(I,2);CHR$(8);"."
...
6820 FOR J=(I-1)*24+1 TO(I-1)*24+22 STEP 3:PRINT" ";MID$(Q$,J,3);:NEXT J:PRINT"|
";I;
6830 ON I GOTO 6850,6900,6960,7020,7070,7120,7180,7240
6850 PRINT"        STARDATE          ";:PRINT USING"####.#";INT(T*10)*.1:
     GOTO 7260
6900 PRINT"        CONDITION          ";:IF C$="*RED*" THEN 
     PRINT CHR$(22);"*RED*";CHR$(22) ELSE IF C$="DOCKED" THEN PRINT 
     CHR$(22);"DOCKED";CHR$(22) ELSE PRINT C$
6902 GOTO 7260
...
8160 PRINT"YOU ARE AT QUADRANT ";Q1;CHR$(8);",";Q2;
     " SECTOR ";S1;CHR$(8);",";S2;CHR$(8);"."
