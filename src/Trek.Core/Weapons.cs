...
namespace Trek.Models
{
    ...
    /// </summary>
    public class EnergyWeaponClass : WeaponClass
    {
        public Metric EnergyCost { get; set; }
    }

    public class ProjectileWeaponClass : WeaponClass
    {
        /// <summary>
        ...
        private Rate _velocity = 0.0;
        public Rate Velocity
        {
            get => _velocity;
            set
            {
    ...
    public interface IWeaponStore<WC> where WC : WeaponClass
    {
        WC WeaponClass { get; }
        bool AddCapacity();
        bool RemoveCapacity();
    ...
    public class Weapon<WC> where WC : WeaponClass
    {
